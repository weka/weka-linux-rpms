...
Name:           weka-rocky-release%{?rltype}
Version:        8.10
Release:        50.2%{?dist}
...
Provides:       weka-rocky-release = %{version}-%{release}
Provides:       weka-rocky-release(upstream) = %{full_release_version}
...
Requires:       weka-rocky-repos(%{major})
Requires:	sed
...
%package     -n weka-rocky-repos%{?rltype}
...
Provides:       weka-rocky-repos(%{major}) = %{full_release_version}
...
%description   -n weka-rocky-repos%{?rltype}
This package provide repo definitions for WEKA Rocky Linux 8.10
...
ln -s rocky-release %{buildroot}%{_sysconfdir}/weka-rocky-release
...
%{_sysconfdir}/weka-rocky-release
...
%files -n weka-rocky-repos%{?rltype}
%license LICENSE
